...
public class DeleteFavorForumSteps {
	@StepMethodDesc(description="deleteFavorForum,nga interface 58",owner="Ruiyun.Ren")
	...
	private LinkedHashMap<String, String> setParam(InterfaceStepParameter parameter) throws Exception
	{
		...
		String fid=ParamHelper.setParamByThreeWay(parameter, urlParameters, "fid", resultSet.get(1).get(0));
